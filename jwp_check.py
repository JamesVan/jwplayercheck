...
weekago = datetime.datetime.now(datetime.timezone.utc)-datetime.timedelta(days=8)
print(weekago)

response = jwplatform_client.videos.show(start_date=weekago)

videoObject= jwplatform_client.video.show(video_key="avinghMe")
